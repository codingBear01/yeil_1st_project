        ...
        .then((data) => {
          data.forEach((addedSessionInfo) => {
            ...
            item.innerHTML = `
              ...
              <button class="delete_added_session_btn" type="button">➖</button>
            `;
            ...
            //   '.added_session_info_input'
            // );
            // inputs.forEach((input) => console.log(input.value));

            // creadteFeedBtn.addEventListener('click', () => {
            //   const addedSessionId = addedSessionInfo.id;

            //   const form = new FormData();
            //   form.append('addedSessionId', addedSessionId);

            //   fetch(`/feed/addRecord`, {
            //     method: 'POST',
            //     body: form,
            //   }).then((res) => res.json());
            // });
